        ...
        <section id="login">
            ...
            <div class="container">
                <div class="text-right back">
                    <a href="Login" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect button-login logout"><i class="mdi mdi-arrow_back"></i>Voltar</a>
                </div>
                <div class="mdl-card mdl-card-login mdl-registro">
                    ...
                    <div class="mdl-card__supporting-text col-xs-12">
                        ...
                        <div class="col-sm-6">
                            <div class="mdl-input">
                                <input type="text" class="form-control" autocomplete="off" placeholder="Nome completo do capitão do time" id="nombre" maxlength="50" onkeypress="return soloLetras(event);">
                            </div>
                            <div class="mdl-input">
                                <input type="text" class="form-control" autocomplete="off" placeholder="Nome do parceiro" id="canal" maxlength="50">
                            </div>
                        ...
                        <div class="col-sm-6">
                            <div class="mdl-input">
                                <input type="text" class="form-control" autocomplete="off" placeholder="e-mail" id="correo">
                            </div>
                            <div class="mdl-input">
                                <input type="password" class="form-control" autocomplete="off" placeholder="senha" id="password">
                            </div>
                            ...
                            <div class="col-xs-12 p-0">
                                <div class="col-xs-9 p-0">
                                    <label class="mdl-checkbox mdl-js-checkbox mdl-js-ripple-effect" for="checkbox-1">
                                        ...
                                        <span class="mdl-checkbox__label"><a onclick="modalTerminos()">Aceito os termos e condições</a></span>
                                    </label>
                                </div>
                                <div class="col-xs-3 p-0 text-right">
                                    <button type="button" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect button-login ingresar" onclick="registrar();">Gravar dados</button>
                                </div>
                            </div>
                        </div>
                    </div>
