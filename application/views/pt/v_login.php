        ...
        <section id="login">
            ...
            <div class="header">
                ...
                <div class="header-right idioma">
                    <a href="../Es/Login">Espa&ntilde;ol</a>
                    ...
                    <div class="mdl-card__supporting-text">
                        ...
                        <div class="col-sm-6 m-t-50">
                            ...
                            <div class="mdl-input transparent">
                                <input type="text" class="form-control" placeholder="e-mail" id="correo" onkeyup="verificarDatos(event);">
                            </div>
                            <div class="mdl-input transparent">
                                <input type="password" class="form-control" placeholder="senha" id="password" onkeyup="verificarDatos(event);">
                            </div>
                            <div class="m-t-20">
