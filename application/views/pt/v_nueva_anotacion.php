...
<html lang="es">
    ...
    <body>
                ...
                <div class="mdl-card-anotaciones">
                    ...
                    <div class="mdl-card mdl-card-cuentas">
                        ...
                        <div class="mdl-card__supporting-text registro">
                            ...
                            <div class="form-group">
                                <textarea type="texto" rows="2" class="form-control" placeholder="Nome do detalhe, telefone e e-mail do contato do cliente" id="descripcion"></textarea> 
                            </div>
                            ...
                            <div class="col-xs-6 p-0 text-right">
                                <button class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect button-login ingresar" id="idNuevaAnotacion" onclick="nuevaAnotacion()">Salvar<i class="mdi mdi-play_arrow"></i></button>
                            </div>
                        </div>
        ...
        <script src="<?php echo RUTA_JS?>ptnueva_anotacion.js?v=<?php echo time();?>"></script>
