...
<html lang="es">
    ...
    <body>
                    ...
                    <div class="mdl-card mdl-card-cuentas">
                        <div class="mdl-card__title">
                            ...
                            <div class="puntaje">
                                ...
                                <p class="m-0 inline">GOALS</p>
                            </div>
                        </div>
                        <div class="mdl-card__supporting-text registro">
                            <div class="form-group">
                                <input type="texto" class="form-control" placeholder="Company name NNN" id="empresa">
                            </div>
                            <div class="form-group">
                                <input type="texto" class="form-control" placeholder="Country" id="pais">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <textarea type="texto" rows="2" class="form-control" placeholder="Description" id="descripcion"></textarea> 
                            </div>
                            <div class="col-xs-6 p-0">
                                <div class="form-group input-date">
                                    ...
                                    <input type="texto" class="form-control" id="fecha" name="fecha" maxlength="10" placeholder="dd/mm/yyyy" style="pointer-events: none;">
                                </div>
                            </div>
                            <div class="col-xs-6 p-0 text-right">
                                <button class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect button-login ingresar" id="idNuevaAnotacion" onclick="nuevaAnotacion()">Annotate<i class="mdi mdi-play_arrow"></i></button>
                            </div>
                        </div>
                        <div class="col-xs-12 p-0 info">
                            <p>(*) Remember that you can upload any case of success, it doesn't necessarily have to be related to football.<a href="https://crpa4c19efc4.hana.ondemand.com/cat/ci/public/ui/nominations/" target="_blank"> Make your denomination here.</a></p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <script src="<?php echo RUTA_JS?>nueva_anotacion_en.js?v=<?php echo time();?>"></script>
