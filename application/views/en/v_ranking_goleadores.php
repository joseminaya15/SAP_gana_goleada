                ...
                <div class="mdl-card mdl-card-ranking">
                    ...
                    <div class="mdl-card__supporting-text p-t-0">
                        <ul class="nav nav-tabs m-b-20" role="tablist">
                            ...
                            <li role="presentation"><a href="#norte" aria-controls="norte" role="tab" data-toggle="tab">North</a></li>
                            <li role="presentation"><a href="#sur" aria-controls="sur" role="tab" data-toggle="tab">South</a></li>
                            <li role="presentation"><a href="#brasil" aria-controls="brasil" role="tab" data-toggle="tab">Brazil</a></li>
                            <li role="presentation"><a href="#mexico" aria-controls="mexico" role="tab" data-toggle="tab">Mexico</a></li>
                        </ul>
