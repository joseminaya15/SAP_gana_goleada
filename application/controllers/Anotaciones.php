          ...
          if($key->Id_serv == 1){
              if($key->Flag == 2){
                  ...
                  $html .= '<tr>
                            ...
                            <td class="text-center"><button id="buttonAlert'.$cont.'" class="mdl-button mdl-js-button mdl-button--icon '.$mensaje.'" onclick="showModalAlert('.$key->alertas.','.$cont.')" '.$alertas.'><i class="mdi mdi-email"></i></button></td>
                          </tr>';
              }else {
                  if($key->Flag == 1) {
